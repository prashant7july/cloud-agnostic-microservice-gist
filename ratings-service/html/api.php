...
class RatingsAPI extends API {
    ...
    private function _dbConnect() {
        //mysql:host=rating-mysql;dbname=ratings;charset=utf8mb4
        //mysql:host=rating-mysql;port=3307;dbname=ratings;charset=utf8mb4
        ...
        $db = false;
        $username = getenv('RATING_MYSQL_USER') ? getenv('RATING_MYSQL_USER') : 'ratings';
        $password = getenv('RATING_MYSQL_PASSWORD') ? getenv('RATING_MYSQL_PASSWORD') : 'secret';
        try {
