...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        JDBC_URL = String.format("jdbc:mysql://%s:3306/cities?useSSL=false&autoReconnect=true", System.getenv("SHIPPING_DB_HOST") != null ? System.getenv("SHIPPING_DB_HOST") : "mysql");
        //Not Work
        //JDBC_URL = String.format("jdbc:mysql://%s:%s/cities?useSSL=false&autoReconnect=true", (System.getenv("SHIPPING_DB_HOST") != null ? System.getenv("SHIPPING_DB_HOST") : "mysql"), (System.getenv("SHIPPING_DB_PORT") != null ? System.getenv("SHIPPING_DB_PORT") : "3306"));
        ...
        try {
            ...
            //cpds.setJdbcUrl( "jdbc:mysql://mysql:3306/cities" ); //Tested
